...
INSERT INTO `Absence` (`refid`, `dateDebut`, `dateFin`, `refCodeMotif`) VALUES
('a131',  '2017-05-10', '2017-10-10', 'A1'),
('a131',  '2017-10-01', '2017-10-02', 'M1')
ON DUPLICATE KEY UPDATE `refid` = VALUES(`refid`), `dateDebut` = VALUES(`dateDebut`), `dateFin` = VALUES(`dateFin`), `refCodeMotif` = VALUES(`refCodeMotif`);
...
('a131',  '09', 0,  0.00, '2017-10-05', 'CL'),
('a131',  '10', 0,  0.00, '2017-10-05', 'CR')
...
INSERT INTO `Praticien` (`id`, `refCode`, `nom`) VALUES
('aaaa',  'oste', 'Dany'),
('bbbb',  'vete', 'Axel'),
('cccc',  'oste', 'Mahery')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `refCode` = VALUES(`refCode`), `nom` = VALUES(`nom`);
...
CREATE TABLE `Visite` (
  `numVisite` int(1) NOT NULL AUTO_INCREMENT,
  `idVisiteur` char(4) NOT NULL,
  `idPraticien` char(4) NOT NULL,
  `finDeVisite` date NOT NULL,
...
INSERT INTO `Visite` (`numVisite`, `idVisiteur`, `idPraticien`, `finDeVisite`, `niveau`) VALUES
(5, 'a131', 'bbbb', '2017-10-11', 5)
ON DUPLICATE KEY UPDATE `numVisite` = VALUES(`numVisite`), `idVisiteur` = VALUES(`idVisiteur`), `idPraticien` = VALUES(`idPraticien`), `finDeVisite` = VALUES(`finDeVisite`), `niveau` = VALUES(`niveau`);
...
('a131',  'Villechalane', 'Louis',  'test', 'test', '8 rue des Charmes',  '46000',  'Cahors', '2005-12-21'),

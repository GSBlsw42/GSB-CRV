...
function valideInfosAbs($dateDebut,$dateFin,$motif){
	if($dateDebut==""){
		ajouterErreur("Le champ date de début ne doit pas être vide");
	}
	else{
		if(!estDatevalide($dateDebut)){
			ajouterErreur("Date de début invalide");
		}
	}
	if($dateFin==""){
		ajouterErreur("Le champ date de fin ne doit pas être vide");
		}
		else{
